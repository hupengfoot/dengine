#define NGX_CONFIGURE " --with-http_upstream_check_module --add-module=ngx_dynamic_proxy_pass_module --with-luajit-inc=/usr/local/include/luajit-2.0 --with-luajit-lib=/usr/local/lib/ --with-http_lua_module --add-module=ngx_http_dyups_module --add-module=/Users/hupeng/Downloads/tengine-1.4.6/echo-nginx-module/ --with-debug --with-cc-opt=-O0 --add-module=nginx_upstream_hash/"
